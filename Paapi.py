...
logo = """
   Ali Maahi
   ▄︻̷̿┻̿═━一
   THE ANONYMOUS Ali maahi TRICKER 
   THE LEGEND ℒℴνℯ
...
\033[1;96mGitHub  \033[1;93m: \033[1;92mhttps://github.com/partner302/love
\033[1;96mBlogger \033[1;93m: \033[1;92mhttps://www.facebook.com/lSanwla larka
\033[1;91m======================================="""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
\033[1;91m======================================="""
print " \x1b[1;93m============================================================="
CorrectUsername = "Desi"
CorrectPassword = "Desi"
loop = 'true'
while (loop == 'true'):
